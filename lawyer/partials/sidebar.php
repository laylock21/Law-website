...
<aside class="lawyer-sidebar collapsed" id="lawyerSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="availability.php" class="sidebar-link <?php echo ($active_page === 'availability') ? 'active' : ''; ?>">
            <i class="fas fa-clock"></i>
            <span>Availability</span>
        </a>
        <a href="edit_profile.php" class="sidebar-link <?php echo ($active_page === 'profile') ? 'active' : ''; ?>">
