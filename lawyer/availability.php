    ...
    try {
        ...
        if ($action === 'add_weekly') {
            ...
            $check_stmt = $pdo->prepare("
                ...
                WHERE lawyer_id = ? AND specific_date = ? AND schedule_type = 'one_time' AND max_appointments > 0
            ");
            ...
            // Insert blocked date
            $insert_stmt = $pdo->prepare("
                INSERT INTO lawyer_availability (lawyer_id, schedule_type, specific_date, blocked_reason) 
                VALUES (?, 'blocked', ?, ?)
            ");
